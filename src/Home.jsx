    ...
    <Router>
      ...
      <PageWrapper>
        <Routes>
          ...
          <Route path="/deposer_place" element={!isAuthenticated ?  <Navigate to="/deposer_place" /> : <PrivateRoute element={DeposerPlace} />} />
          ...
          {isAuthenticated && <Route path="/edit-place/:id" element={<EditPlace />} />}
