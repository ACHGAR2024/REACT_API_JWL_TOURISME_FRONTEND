      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <a href="https://www.844.fr/public-transport/horaires-theoriques-du-reseau-transports-en-commun-lyonnais-tcl-sytral" className="text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400">
              <h3 className="text-xl font-semibold mb-2">
                <i className="fas fa-subway mr-2 text-red-600 dark:text-red-400"></i>Transports
              </h3>
              <p className="text-gray-700 dark:text-gray-300">Informations sur les transports en commun à Lyon</p>
              <ul>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <a href="https://www.t-libr.fr/carte-interactive-t-libr/" className="text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400">
              <h3 className="text-xl font-semibold mb-2">
                <i className="fas fa-parking mr-2 text-blue-600 dark:text-blue-400"></i>Parkings
              </h3>
              <p className="text-gray-700 dark:text-gray-300">Trouver un parking dans le centre-ville</p>
              <ul>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <a href="https://www.google.com/maps/place/Office+du+Tourisme+et+des+Congr%C3%A8s+de+la+M%C3%A9tropole+de+Lyon/@45.7574485,4.8322726,18.3z/data=!4m6!3m5!1s0x47f4ea52524c379d:0xf9d5cec9fb0755fe!8m2!3d45.7570797!4d4.8330122!16s%2Fg%2F1thgjbz7?entry=ttu" className="text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400">
              <h3 className="text-xl font-semibold mb-2">
                <i className="fas fa-map-signs mr-2 text-green-600 dark:text-green-400"></i>Offices de tourisme
              </h3>
              <p className="text-gray-700 dark:text-gray-300">Localisations et horaires des offices de tourisme</p>
              <ul>
                {tourismData.map((item, index) => (
                  <li key={index} className="mt-2">
                    <h4 className="text-lg font-semibold">{item.name}</h4>
                    <p className="text-gray-600 dark:text-gray-400">{item.description}</p>
                    <p className="text-gray-600 dark:text-gray-400"><strong>Horaires:</strong> {item.hours}</p>
                    <p className="text-gray-600 dark:text-gray-400"><strong>Adresse:</strong> {item.address}</p>
                  </li>
                ))}
              </ul>
            </a>
